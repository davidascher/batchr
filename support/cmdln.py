...
__revision__ = "$Id: cmdln.py 635 2005-10-18 06:30:05Z trentm $"
...
class RawCmdln(cmd.Cmd):
    ...
    def do_help(self, argv):
        ...
        if len(argv) > 1: # asking for help on a particular command
            ...
            # Prefix command help with the command name and aliases (a
            # la 'svn').
            #XXX Make this optional and *on* by default.
            doc = "${cmd_name}: " + doc
